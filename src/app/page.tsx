...
export const metadata: Metadata = {
  ...
  description:
    "Cabinet Boury & Associés, orthodontie pour enfants, adolescents et adultes à Laon. Traitements modernes, gouttières invisibles, multi-attaches. RDV en ligne.",
};
...
export default function HomePage() {
  return (
    <main>
      ...
      <section className="relative min-h-[85vh] flex items-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 py-24 sm:py-32 w-full">
          <div className="max-w-2xl">
            ...
            <p className="text-primary-light font-medium text-sm sm:text-base uppercase tracking-[0.2em] mb-4">
              Cabinet Boury &amp; Associés
            </p>
            <h1 className="font-[family-name:var(--font-heading)] text-4xl sm:text-6xl font-bold leading-tight text-white mb-6">
              Orthodontie moderne<br />à Laon
            </h1>
            ...
            <div className="flex flex-col sm:flex-row items-start gap-4">
              <Link
                href="/rendez-vous"
                className="inline-block rounded-full bg-primary hover:bg-primary-dark text-white font-semibold px-8 py-3.5 transition-all duration-300 shadow-lg hover:shadow-xl hover:-translate-y-0.5"
              >
                RDV en ligne →
              </Link>
              <a
                ...
                className="inline-block rounded-full border-2 border-white/30 text-white font-semibold px-8 py-3.5 hover:bg-white/10 backdrop-blur-sm transition"
              >
                Nous trouver
              </a>
            </div>
      ...
      <section id="presentation" className="py-16 sm:py-24 bg-warm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="section-divider mb-6" />
              <h2 className="font-[family-name:var(--font-heading)] text-3xl sm:text-4xl font-bold text-dark mb-6">
      ...
      <section className="py-16 sm:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <h2 className="font-[family-name:var(--font-heading)] text-3xl sm:text-4xl font-bold text-dark text-center mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
            {/* Technologies */}
            <div>
              <h3 className="font-[family-name:var(--font-heading)] text-xl font-semibold text-dark mb-4">
                Nos technologies
              </h3>
      ...
      {/* ───────────── 4. TREATMENTS ───────────── */}
      <section id="traitements" className="bg-warm py-16 sm:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="section-divider mx-auto mb-6" />
          <h2 className="font-[family-name:var(--font-heading)] text-3xl sm:text-4xl font-bold text-dark text-center mb-12">
            Nos expertises
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {treatments.map((t) => (
              <Link
                key={t.number}
                href={t.link}
                className="group block bg-white rounded-2xl p-8 hover:shadow-lg transition-shadow duration-300 border-b-4 border-transparent hover:border-primary"
              >
                <span className="text-5xl font-bold text-primary/20 block mb-4 font-[family-name:var(--font-heading)]">
                  {t.number}
                </span>
      ...
      <section className="py-16 sm:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="section-divider mx-auto mb-6" />
          <h2 className="font-[family-name:var(--font-heading)] text-3xl sm:text-4xl font-bold text-dark text-center mb-4">
            Galerie
          </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
            {patientCards.map((card) => (
              <Link
                key={card.link}
                href={card.link}
                className="group flex items-center justify-center bg-white rounded-2xl p-10 text-center shadow-sm hover:shadow-lg transition-shadow duration-300 border-b-4 border-transparent hover:border-primary"
              >
                <h3 className="font-[family-name:var(--font-heading)] text-xl font-semibold text-dark group-hover:text-primary transition-colors">
                  {card.title}
                </h3>
              </Link>
            ))}
      ...
      <section className="bg-warm py-16 sm:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 text-center">
          <div className="section-divider mx-auto mb-6" />
          <h2 className="font-[family-name:var(--font-heading)] text-3xl sm:text-4xl font-bold text-dark mb-4">
            Dentapoche
          </h2>
          <h3 className="font-[family-name:var(--font-heading)] text-xl text-primary font-semibold mb-4">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-block rounded-full bg-dark text-white font-semibold px-8 py-3 shadow-md hover:shadow-lg hover:-translate-y-1 hover:bg-dark/90 transition-all duration-300"
            >
              App Store
            </a>
            <a
      ...
      <section className="bg-accent text-white py-16 sm:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="w-[60px] h-[3px] bg-primary rounded mx-auto mb-6" />
          <h2 className="font-[family-name:var(--font-heading)] text-3xl sm:text-4xl font-bold text-center mb-8">
            ...
            <div className="space-y-8">
              <div className="bg-warm rounded-2xl p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-[family-name:var(--font-heading)] text-xl font-semibold text-dark mb-2">Adresse</h3>
                    <p className="text-muted text-lg">35 bis rue du Colombier</p>
                    <p className="text-muted text-lg">02 000 Laon</p>
                  </div>
                </div>
              </div>
              <div className="bg-warm rounded-2xl p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-[family-name:var(--font-heading)] text-xl font-semibold text-dark mb-2">Téléphone</h3>
                    <p className="text-lg">
                      <a href="tel:0323233545" className="text-primary hover:underline font-medium">
                        03 23 23 35 45
                      </a>
                    </p>
                  </div>
      ...
      {/* ───────────── 10. CONTACT FORM ───────────── */}
      <section id="contact" className="bg-warm py-16 sm:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="max-w-2xl mx-auto">
            ...
            <p className="text-muted text-center text-lg mb-10 leading-relaxed">
            ...
            <form className="space-y-6">
              <div>
                ...
                <input
                  ...
                  name="nom"
                  required
                  className="w-full rounded-xl border border-gray-200 bg-white px-4 py-3.5 text-dark placeholder-gray-400 focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none transition shadow-sm"
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={5}
                  required
                  className="w-full rounded-xl border border-gray-200 bg-white px-4 py-3.5 text-dark placeholder-gray-400 focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none transition shadow-sm resize-y"
              ...
              <div className="text-center">
                <button
                  type="submit"
                  className="inline-block rounded-full bg-primary text-white font-semibold px-10 py-3 shadow-md hover:shadow-lg hover:bg-primary-dark transition-all duration-300"
                >
                  Envoyer
                </button>
              </div>
