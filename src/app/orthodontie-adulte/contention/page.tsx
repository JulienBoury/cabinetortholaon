...
export const metadata: Metadata = {
  ...
  description:
    "La contention orthodontique : fil collé et gouttière de contention pour stabiliser vos résultats après un traitement orthodontique. Cabinet d'orthodontie à Laon.",
};
