...
export const metadata: Metadata = {
  title: "Docteur Louise Lamarche",
  description:
    "Dr Louise Lamarche, chirurgien dentiste au cabinet d'orthodontie Boury & Associés à Laon.",
};
...
const qualifications = [
  ...
  "D.I.U. Orthopédie Dento-Cranio-Maxillo-Faciale (Paris VI)",
];
...
export default function DocteurLouiseLamarchePage() {
  return (
    <>
      {/* Hero */}
      <section className="bg-gradient-to-br from-accent via-dark to-accent text-white py-20">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <h1 className="text-4xl md:text-6xl font-bold mb-4 font-[family-name:var(--font-heading)]">
            Docteur Louise Lamarche
          </h1>
          <p className="text-lg md:text-xl opacity-90">
            Chirurgien dentiste &mdash; Cabinet Boury &amp; Associés, Laon
          </p>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center gap-12">
          <div className="shrink-0">
            <Image
              src={img("/photos/equipe/louise-lamarche.jpg")}
              alt="Docteur Louise Lamarche"
              width={400}
              height={600}
